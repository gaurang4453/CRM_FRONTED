...
const Footer = ({ onSave, onDelete,onCancel  }) => {
  ...
  return (
    <footer className="position-fixed start-0 end-0 bottom-0 d-flex flex-row justify-content-end align-items-end" style={{ backgroundColor: '#0d254b' , height:"50px" }}>
        ...
        <div className="py-1 px-lg-5">
          <button type="button" className="btn btn-light mx-1" onClick={onSave}>
            Save
          </button>
          ...
          <button type="button" className="btn btn-secondary mx-1 " onClick={onCancel}>
            Cancel
          </button>
        </div>
      {/* </div> */}
